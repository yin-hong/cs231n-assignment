...
from cs231n.rnn_layers import lstm_forward
from cs231n.rnn_layers import lstm_backward
from cs231n.rnn_layers import lstm_step_forward
class CaptioningRNN(object):
    ...
    """
    def __init__(self, word_to_inx, input_dim=512, wordvec_dim=128,
        ...
        self.dtype = dtype
        self.word_to_idx = word_to_inx
        self.idx_to_word = {i: w for w, i in word_to_inx.items()}
        self.params = {}

        vocab_size = len(word_to_inx)

        self._null = word_to_inx['<NULL>']
        self._start = word_to_inx.get('<START>', None)
        self._end = word_to_inx.get('<END>', None)
        ...
        # Cast parameters to cerrect dtype
